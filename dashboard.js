...
function setRealtimeStatus(online, message) {
    ...
    if (online) {
        ...
        status.textContent =
            "🟢 " +
            (message || "Live database updates enabled");
        ...
        status.textContent =
            "🟠 " +
            (message || "Live updates unavailable. Refreshing normally.");
    }
}
...
async function loadStatistics() {
    ...
    try {
        ...
        setText("studentCount", values[0]);
        setText("teacherCount", values[1]);
        setText("classCount", values[2]);
        setText("subjectCount", values[3]);
        setText("feeCount", values[4]);
        setText("resultCount", values[5]);
...
function startRealtime() {
    ...
    realtimeChannel = db
        .channel("school-dashboard-realtime")
